let
    ...
    MainURL = "https://www.compare-school-performance.service.gov.uk/download-data?download=true&regions=0&filters=" & Keyword & "&fileformat=csv&year=" & Text.From(YearRef)&"-"&Text.From(YearRef + 1) & "&meta=false",
    
    // Create URL for academic year two years ago
    // Edit uppercase keyword after &filters= to get different types of data
    BackupURL = "https://www.compare-school-performance.service.gov.uk/download-data?download=true&regions=0&filters=" & Keyword & "&fileformat=csv&year=" & Text.From(YearRef - 1)&"-"&Text.From(YearRef) & "&meta=false",
